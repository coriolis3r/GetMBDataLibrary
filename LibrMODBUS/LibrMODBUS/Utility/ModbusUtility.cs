...
namespace Modbus.Utility
{
	...
	public static class ModbusUtility
	{
        ...
        public static double GetDouble(ushort byte1, ushort byte2, ushort byte3, ushort byte4)
        {
            return BitConverter.ToDouble(BitConverter.GetBytes(byte4).Concat(BitConverter.GetBytes(byte3).Concat(BitConverter.GetBytes(byte2).Concat(BitConverter.GetBytes(byte1)))).ToArray(), 0);
        }
        ...
        /// <summary>
        /// Converts two UInt16 values into a long
        /// </summary>
        public static long GetLong(ushort byte1, ushort byte2, ushort byte3, ushort byte4)
        {
            return BitConverter.ToInt64(BitConverter.GetBytes(byte4).Concat(BitConverter.GetBytes(byte3).Concat(BitConverter.GetBytes(byte2).Concat(BitConverter.GetBytes(byte1)))).ToArray(), 0);
        }
